                ...
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div>
                        <span className="bg-gradient-to-r from-[#ec3e52] to-[#2b6ac4] inline-block text-transparent bg-clip-text">
                            Smart Editor</span>
                        <h2 className="text-white-950 mt-4 text-4xl font-semibold">Allow Datavanta to make your graphs</h2>
                    ...
                    <div className="border-foreground/5 space-y-6 [--color-border:color-mix(in_oklab,var(--color-foreground)10%,transparent)] sm:space-y-0 sm:divide-y">
                        <div className="grid sm:grid-cols-5 sm:divide-x">
                            ...
                            <div className="mt-6 sm:col-span-3 sm:mt-0 sm:border-l sm:border-[#1b1c1c] sm:pl-12">
                                <h3 className="text-[#2b6ac4] text-xl font-semibold">Marketing Campaigns</h3>
                        ...
                        <div className="grid sm:grid-cols-5 sm:divide-x border-[#1b1c1c]">
                            <div className="pt-12 sm:col-span-3 sm:pr-12">
                                <h3 className="text-[#ec3e52] text-xl font-semibold">AI Meeting Scheduler</h3>
                            ...
                            <div className="sm:border-r sm:border-[#1b1c1c] row-start-1 flex items-center justify-center pt-12 sm:col-span-2 sm:row-start-auto">
...
export const ScheduleIllustation = ({ className, variant = 'elevated' }: IllustrationProps) => {
    return (
        <div className={cn('relative', className)}>
            <div
                className={cn('bg-[#1b1c1c] -translate-x-1/8 absolute flex -translate-y-[110%] items-center gap-2 rounded-lg p-1', {
            ...
            <span>
                <span className="bg-yellow-500 text-yellow-100 py-1">Tomorrow 8:30 pm</span> is our priority.
            </span>
        </div>
    )
}

            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto grid gap-2 sm:grid-cols-5">
                    <Card className="group overflow-hidden shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <CardHeader>
                            <div className="md:p-6">
                                <p className="font-medium">Comprehensive chart library</p>
                                <p className="text-muted-foreground mt-3 max-w-sm text-sm">Choose from bar charts, line graphs, area charts, pie charts, and more. Each chart type is fully customizable with modern styling options.</p>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl">
                        <p className="mx-auto my-6 max-w-md text-balance px-6 text-center text-lg font-semibold sm:text-2xl md:p-6">Intuitive interface, instantly create beautiful graphs.</p>
                    ...
                    <Card className="group p-6 shadow-black/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl md:p-12">
                        <p className="mx-auto mb-12 max-w-md text-balance text-center text-lg font-semibold sm:text-2xl">Professional styling, customize every detail.</p>
                    ...
                    <Card className="group relative shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-br-xl">
                        <CardHeader className="p-6 md:p-12">
                            ...
                            <p className="text-muted-foreground mt-2 max-w-sm text-sm">Export your charts in multiple formats and share your visualizations with ease.</p>
                        </CardHeader>

...
export default function FeaturesSection2() {
    return (
     <section className="relative py-24 md:py-48 overflow-hidden bg-muted/10">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                
                <div className="relative z-10 grid items-center gap-4 md:grid-cols-2 md:gap-12 mb-5">
                    <h2 className="text-4xl font-semibold">Everything you need to create stunning visualizations</h2>
                    <p className="max-w-sm sm:ml-auto">From simple bar charts to complex interactive dashboards, Datavanta provides all the tools you need to transform your data into beautiful, professional graphs.</p>
                </div>

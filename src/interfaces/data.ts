...
export interface Project {
    ...
    description: string;
    data: DataPoint[];
    chartType: 'bar' | 'bar-horizontal' | 'line' | 'line-dots' | 'line-step' | 'pie' | 'donut' | 'area' | 'area-step' | 'area-gradient' | 'stacked-bar' | 'stacked-area' | 'radar' | 'radar-lines' | 'radar-dots' | 'scatter' | 'heatmap';
    chartColor: string;
    chartColor2?: string;
